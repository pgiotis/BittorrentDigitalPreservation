<?php
	 ...
	 * Default: No (false).
	 */
	$GLOBALS["allow_group_admin"] = true;
	...
	$GLOBALS["move_to_db"] = true;
	$GLOBALS["max_torrent_size"] = 10737418240;
	$GLOBALS["torrent_folder"] = "http://localhost/tracker/torrents";
	 ...
	 */
	$GLOBALS["my_tracker_announce"] = "http://localhost/tracker/tracker.php/announce";
	 ...
	 */
	$dbhost = "localhost";  $dbuser = "tracker";  $dbpass = "123";  $database = "tracker";
?>
